...
public class Recipe {
    ...
    public Recipe(Long id, String title, String cuisine, Float rating, Integer prep_time, Integer cook_time, Integer total_time, String description, Nutrients nutrition, String serves) {
        this.id = id;
        this.title = title;
